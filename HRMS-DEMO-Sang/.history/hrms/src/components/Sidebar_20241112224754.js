    ...
    <div className="sidebar">
      ...
      <li>
        ...
        <li>
          ...
          {isPerformanceOpen && (
            <ul className="submenu">
                  <li><NavLink to="/performance/performane-dashboard">Dashboard</NavLink></li>
                  <li><NavLink to="/performance/objectives">Objectives</NavLink></li>
                  <li><NavLink to="/performance/360-feedback">360 Feedback</NavLink></li>
                  <li><NavLink to="/performance/meetings">Meetings</NavLink></li>
                </ul>
          )
