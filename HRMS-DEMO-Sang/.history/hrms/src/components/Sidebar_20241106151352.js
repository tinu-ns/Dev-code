      ...
      <li>
        ...
        <li>
          <NavLink to="/leave" activeClassName="active">
            ...
            {/* Payroll section */}
        <li>
        <span onClick={togglePayrollMenu} className="menu-toggle">
              Payroll
            </span>
          ...
          {isPayrollOpen && (
            <ul className="submenu">
              ...
              <li><NavLink to="/payroll/payroll">Payroll</NavLink></li>
              <li><NavLink to="/payroll/loan-advance-salary">Loan / Advance Salary</NavLink></li>
              <li><NavLink to="/payroll/encashments-reimbursements">Encashments & Reimbursements</NavLink></li>
