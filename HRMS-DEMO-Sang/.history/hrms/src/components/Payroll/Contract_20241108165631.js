            ...
            <div className="form-row">
              <div className="form-group">
                <label>
                  ...
                  <FaInfoCircle title="Contract information" className="info-icon"/>
                </label>
                <input
                  type="text"
                  name="contractTitle"
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <select name="position" onChange={handleInputChange}>
                  ...
                  <option value="HR Dept">HR Dept</option>
                  <option value="Sales Dept">{("Sales Man- (Sales Dept)")}</option>
                  <option value="S/W Dept">{("Django Dev- (S/W Dept)")}</option>
                  <option value="Marketing Dept">{("Digital Marketig Specialist - (Marketing Dept)")}</option>
                  <option value="Finance Dept">{("Accountant - (Finance Dept)")}</option>
                  <option value="IT Dept">{("Software Engineer- (IT Dept)")}</option>
                </select>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select name="role" onChange={handleInputChange}>
                  ...
                  <option value="Marketing Dept">Marketig Manager - Marketing Dept</option>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                <label>
                  ...
                  <FaInfoCircle className="info-icon" title="Notice period in total days" />
                </label>
                <input
                  type="number"
                  name="noticePeriod"
            ...
            <div className="form-row half-width">
              <div className="form-group">
                <label>
                  ...
                  <FaInfoCircle className="info-icon" title="Deduct the leave amount from basic pay" />
                </label>
              ...
              <div className="form-group">
                <label>
                  ...
                  <FaInfoCircle title="Leave amount will be calculated by dividing basic pay by working days" className="info-icon"/>
                </label>
