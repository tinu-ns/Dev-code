    ...
    <div className="create-allowance-container">
      ...
      <form>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label>Is condition based</label> <span>*</span>
            <FaInfoCircle className="info-icon" title="The filled is used to target allowance to the specific employees when the conditions satisfied with the employees information" />
            <label className="toggle-switch">
