...
const Contract = () => {
  ...
  const applyFilter = () => {
    ...
    const filtered = contracts.filter((contract) =>
      contract.employee.toLowerCase().includes(filterData.employeeName.toLowerCase()) &&
      (filterData.contractStatus ? contract.contract === filterData.contractStatus : true)
    );
    ...
    <div className="contract-page">
      ...
      <div className="header-container">
        ...
        <div className="header-right">
          ...
          <button className="create-button" onClick={() => setShowCreatePage(true)}>
            Create
          </button>
        </div>
      </div>
