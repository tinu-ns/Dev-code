                ...
                <div className="filter-modal">
                    <div className="filter-modal-content">
                        ...
                        <div className="filter-section-advanced">
                            ...
                            <div className="form-row">
                                <label>Gross Pay Less Than or Equal</label>
                                ...
                                <label>Gross Pay Greater or Equal</label>
                            ...
                            <div className="form-row">
                                <label>Deduction Less Than or Equal</label>
                                ...
                                <label>Deduction Greater or Equal</label>
                            ...
                            <div className="form-row">
                                <label>Net Pay Less Than or Equal</label>
                                ...
                                <label>Net Pay Greater or Equal</label>
