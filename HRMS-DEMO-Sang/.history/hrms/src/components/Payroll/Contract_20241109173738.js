...
const Contract = () => {
  ...
  const handleApplyFilter = () => {
    setShowFilterPopup(false);
    // Implement filter logic here if needed to update displayed data
  };

  const applyFilteredContracts = contracts.filter((contract) =>
    (filterData.status === "" || contract.contract === filterData.status) &&
    (filterData.wageType === "" || contract.wageType === filterData.wageType)
  );
     ...
     {showFilterPopup && (
        <div className="filter-popup-overlay">
          <div className="filter-popup">
            ...
            <button type="button" onClick={const handleApplyFilter = () => {
    setShowFilterPopup(false);
    // Implement filter logic here if needed to update displayed data
  };
