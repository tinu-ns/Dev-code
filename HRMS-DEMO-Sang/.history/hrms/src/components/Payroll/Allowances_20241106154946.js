...
import { FaSearch, FaList, FaTh, FaPlus, FaEdit, FaTrash } from 'react-icons/fa';

const allowancesData = [
  { id: 1, code: 'TA', name: 'Travel Allowance', amount: 200.0, oneTime: 'No', taxable: 'Yes' },
  { id: 2, code: 'HA', name: 'House Rent Allowance', amount: 1000.0, oneTime: 'No', taxable: 'Yes' },
