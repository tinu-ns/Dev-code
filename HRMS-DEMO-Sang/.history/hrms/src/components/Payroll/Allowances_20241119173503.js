              ...
              {editingId === allowance.id ? (
                ...
                <>
                  ...
                  <div className="card-actions">
                    <button
                      className="edit-btn"
                      onClick={() => handleEdit(allowance.id, allowance)}
                    >
                      <FaEdit />
                    </button>
                    <button
    ...
    <tr key={allowance.id}>
      {allowance.isEditing ? (
        <>
          <td className="sticky-column">
            <input
              ...
              onChange={(e) =>
                setFilteredData((prev) =>
                  prev.map((a) =>
                    a.id === allowance.id ? { ...a, name: e.target.value } : a
                  )
                )
              }
            />
          ...
          <td>
            <button
              onClick={() => handleSaveEdit(allowance.id, allowance)}
            >
              Save
            </button>
            <button onClick={() => cancelEdit(allowance.id)}>Cancel</button>
          </td>
        </>
      ) : (
        <>
          ...
          <td className="sticky-column">
            <button onClick={() => handleEdit(allowance.id)}>
              <FaEdit />
            </button>
