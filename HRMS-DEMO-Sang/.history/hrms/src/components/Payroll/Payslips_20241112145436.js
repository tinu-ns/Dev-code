...
import { FaTrash, FaEnvelope, FaFilter, FaPlus, FaDownload, FaTimes, FaTrash } from 'react-icons/fa';
import './Payslips.css';
...
const Payslips = ({data} = []) => {
    const [payslips, setPayslips] = useState([
        { id: 1, employee: 'Adam Luis', startDate: '11/01/2024', endDate: '11/09/2024', batch: 'None', grossPay: 'ETB 2394345.33', deduction: 'ETB 166407.00', netPay: 'ETB 2227938.33' },
        ...
        { id: 3, employee: 'John Deopha (#PEP45)', startDate: '06/29/2000', endDate: '09/30/2022', batch: 'None', grossPay: 'ETB 145674.77', deduction: 'ETB 0.00', netPay: 'ETB 12345.67' },
        { id: 4, employee: 'Herry Potter (#PEP66)', startDate: '02/12/2016', endDate: '07/22/2021', batch: 'None', grossPay: 'ETB 232133.97', deduction: 'ETB 0.00', netPay: 'ETB 67890.67' },
    ...
    const handleRowSelect = (id) => {
      ...
      setIsAllSelected(newSelectedRows.length === filteredPayslips.length);
  };
