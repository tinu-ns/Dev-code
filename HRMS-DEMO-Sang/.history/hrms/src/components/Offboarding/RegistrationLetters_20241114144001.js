    ...
    <div className="resignation-letters">
      <div className="header">
        ...
        <div className="header-controls">
          ...
          />
          <button onClick={() => handleViewChange("list")} className="view-toggle">List View</button>
          <button onClick={() => handleViewChange("grid")} className="view-toggle">Grid View</button>
