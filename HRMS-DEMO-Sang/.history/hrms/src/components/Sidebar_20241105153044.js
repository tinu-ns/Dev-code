    ...
    <div className="sidebar">
      ...
      <li>
        ...
        <li>
          ...
          <button className="menu-toggle" onClick={togglePayrollMenu}>
            Payroll
          </button>
          {isPayrollOpen && (
            <ul className="submenu">
              <li><Link to="/payroll/dashboard">Dashboard</Link></li>
              <li><Link to="/payroll/allowances">Allowances</Link></li>
              <li><Link to="/payroll/contracts">Contracts</Link></li>
              <li><Link to="/payroll/deductions">Deductions</Link></li>
            </ul>
          )}
        </li>
        <li>
