      ...
      <div className="pagination">Page 1 of 1</div>
        ...
        <div className="filter-modal">
          <div className="filter-modal-content">
            ...
            <label>
              Managers:
              <input type="number" value={filter.managers} onChange={e => handleFilterChange('managers', e.target.value)} />
            </label>
            <label>
              Assignees:
              <input type="number" value={filter.assignees} onChange={e => handleFilterChange('assignees', e.target.value)} />
            </label>
            </div>
