...
const TimeOffRequests = () => {
  ...
  return (
    <Box p={3}>
      <Typography variant="h4" gutterBottom>Time Off Requests</Typography>
      ...
      <Box display="flex" gap={2} mb={3}>
        ...
        <Button variant="outlined" startIcon={<GroupWork />} onClick={() => setGroupByOpen(true)}>Group By</Button>
